...
function fn_click_wish()
		{
			...
			$('.wishhh').css('display','none');
		$('#div_wishlist').load('slide_show_wishlist.php #wish_data');
...
// Shopping Cart
	...
	{
		$.post("saar_admin/order_status.php",
		{
			oid:oid
		},
		function(data,status){ 
	...
	function loginnext()
	{
	 ...
	 $("#addresss").addClass("active");
	   ...
	   document.getElementById("addresss").innerHTML = "<a style='padding-left: 115px;' aria-expanded='true'>Address  </a>";	
	   document.getElementById("Review").innerHTML = "<a  style='padding-left: 115px;' aria-expanded='true'>Review order </a>";
	   document.getElementById("paymentt").innerHTML = "<a style='padding-left: 115px;' aria-expanded='true'>Make  payment </a>";
	}
	//Address next
	...
	$("#Emaill").removeClass("active");
	 ...
	 $("#Review").addClass("active");
	   ...
	   document.getElementById("addresss").innerHTML = "<a style='padding-left: 115px;' data-toggle='tab' role='tab'  href='#brand-info' aria-expanded='true'>Address </a>";	
	   document.getElementById("Review").innerHTML = "<a style='padding-left: 115px;' aria-expanded='true'>Review order </a>";
	   document.getElementById("paymentt").innerHTML = "<a style='padding-left: 115px;' ria-expanded='true'>Make  payment </a>";
	...
	{ 
	  ...
	  $("#paymentt").addClass("active");
	   document.getElementById("Review").innerHTML = "<a style='padding-left: 115px;' data-toggle='tab' role='tab'  href='#faq' aria-expanded='true'>Review order </a>";
	   document.getElementById("paymentt").innerHTML = "<a style='padding-left: 115px;' data-toggle='tab' role='tab'  href='#reviews'  aria-expanded='true'>Make  payment </a>";
	}
	   ...
	   function	close_cart(){
	    ...
	    function	close_wish(){
		$(".carttt").css('display','none');
		$(".showww").fadeOut(9000);
	   }
	   
   function	delete_cart(){
	  
		$(".tboddy").css('display','none');
		$(".tboddy").fadeOut(9000);
	   }
