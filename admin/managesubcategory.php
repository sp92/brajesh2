    ...
    <td style="padding-left:10px" >
      ...
      <tr>
			  ...
			  {			  	
			  	if (get("del") == "y")
				{
					if (get("id") != "")
					{
						$id = get("id");
						$cid = $_REQUEST["cid"];
						$sql="select * from products where cat_id=$cid  and prod_cat in (select subcat_id from subcategory where sid= $id)";
						...
						if ($num_rows==0)
						{
							...
							$msg =  "<br>Sub Category Deleted...";
						}
						else
							$msg =  "<br>Error: There are active items attached with this sub category. Hence sub category can't be deleted";
					}
				}
				...
				{			
					...
					{
						$id = get("id");
						$sql="update subcategory set subcat_active = ".get("active")." where sid= $id";
						$query1=mysql_query($sql);
						if ($query1)  $msg = "<br>Sub Category Updated...";
					}
				}
			}
		...
		<div class="my-account" >
		 ...
		 <input name="button" type="button" value="Export Sub Category" onClick="window.open('export/?for=SubCategory-List','iFrame','')">
		 <!-- <form action="" method="get">
          ...
          <table width="100%"  border="0" bgcolor="#D3D3D3">
            <tr>
              <td bgcolor="#FFFFFF">
			  <a href='updatesubcategory.php?id=0<? echo $aj; ?>' class='thickbox' ">Add New</a>
			 <?
				$sn =0;
				$_SESSION['type'] = $type;
				$_SESSION["lang"] = $lang;
				...
				$sql="select *, c.cat_title from category c right join subcategory s on c.cat_id = s.cat_id order by cat_title ";
			 ...
			 ?>
			  ...
			  <table width="100%"  border="0" cellpadding="1" cellspacing="0" >
                ...
                <tr class="table_header" >
				  ...
				  <td width="25%"><span><strong>Sub Category Name </strong></span></td>
				...
				{						
					while($row=mysql_fetch_array($query))
					{
					 ...
					 $col4 = $row['subcat_seq'];
					 $colLast = ($row['subcat_active']==1)?'Yes':'No';
					 $active = ($row['subcat_active']==1)?'0':'1';
					 ...
					 echo "<tr class='$bgcolor' >
						...
						<td align=center><a href='updatesubcategory.php?type=$type&t=$title&id=$id&gid=$colg$aj' class='thickbox' ><u>Edit</u></a>
